...
| Provide reviewed, data-specific programs that remain visible and editable before execution | `app/programming/classic-examples.ts` | Three foodborne `DEFINE -> RECODE -> FREQ` examples using the same AST-to-plan boundary as user source |
