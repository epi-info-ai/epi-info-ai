...
const requiredFiles = [
  ...
  "examples/gis-k06-choropleth/README.md",
  "examples/gis-k06-choropleth/county-boundaries.geojson",
  "examples/gis-k06-choropleth/county-values.csv",
  "examples/gis-k07-dot-density/README.md",
  "examples/gis-k07-dot-density/county-boundaries.geojson",
  "examples/gis-k07-dot-density/county-values.csv",
...
assert.match(html, /src=["']app\.js\?v=132["']/);
