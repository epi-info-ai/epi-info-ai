...
| LEGACY-STORAGE-003 | Microsoft Access project/data store | Read-only Windows conversion tool and official Sample package fixture; no direct browser driver | Adapt through reviewed import/export or conversion tooling; do not silently drop. |
