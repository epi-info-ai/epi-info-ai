...
| EDITOR-009 | Visible source, diagnostics, line numbers, tabs, completion, and cursor position | CodeMirror new-branch assistance is active without expanding execution authority. The insertion point is a high-contrast vertical red rectangle that pulses without becoming invisible; reduced-motion preferences keep it solid | `new branch`, browser tested |
