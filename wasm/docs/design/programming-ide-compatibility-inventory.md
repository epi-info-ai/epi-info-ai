...
| EDITOR-002 | New, Open Pgm, Save Pgm, Save Pgm As, project programs, and metadata | Project-backed programs plus bounded `.pgm`/`.pgm7` text import and `.pgm7` export | `browser-verified` candidate |
