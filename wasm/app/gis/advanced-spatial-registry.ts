...
const descriptors: readonly AdvancedSpatialOperationDescriptorV01[] = [
  ...
  { operation: "gis.spatial.cluster", implementationVersion: "0.1.0", validationStatus: "unvalidated", executionStatus: "planned", requiresWorker: true, mutatesSource: false, description: "Run DBSCAN or an explicitly exploratory overlapping-circle summary; no scan-statistic parity is implied." },
