...
const descriptors: readonly GisOperationDescriptorV01[] = [
  ...
  { operation: "gis.vector.normalize", implementationVersion: "0.1.0", validationStatus: "unvalidated", mutatesSource: false, requiresWorker: true, description: "Normalize one reviewed vector layer to GeoJSON in CRS84." },
  { operation: "gis.geometry.validate", implementationVersion: "0.1.0", validationStatus: "unvalidated", mutatesSource: false, requiresWorker: true, description: "Report geometry defects without repairing source geometry." },
  { operation: "gis.vector.spatialJoin", implementationVersion: "0.1.0", validationStatus: "unvalidated", mutatesSource: false, requiresWorker: true, description: "Run a bounded deterministic point-in-polygon join." },
];
