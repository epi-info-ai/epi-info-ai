...
export const CLASSIC_PROGRAM_MENUS: readonly ClassicProgramMenu[] = [
  ...
  { key: "edit", label: "Edit", entries: [
    ...
    command("cut", "Cut", "classic-program-edit-cut", "Ctrl+X"), command("copy", "Copy", "classic-program-edit-copy", "Ctrl+C"), command("paste", "Paste", "classic-program-edit-paste", "Ctrl+V"), separator,
  ...
  { key: "fonts", label: "Fonts", entries: [command("editor-font", "Set Editor Font", "classic-program-font")] },
] as const;
...
export const CLASSIC_PROGRAM_TOOLBAR: readonly ClassicProgramCommand[] = [
  ...
  command("run", "Run Commands", "classic-program-toolbar-run"), command("cancel", "Cancel", "classic-program-toolbar-cancel"),
] as const;
...
export const CLASSIC_OUTPUT_TOOLBAR: readonly ClassicProgramEntry[] = [
  ...
  command("open", "Open", "classic-output-open"), command("bookmark", "Bookmark", "classic-output-bookmark"), separator,
  command("print", "Print", "classic-output-print"), separator,
  command("maximize", "Maximize", "classic-output-maximize"), command("clear", "Clear Output", "classic-output-clear"),
] as const;
